          ...
          <TabList className="md:flex md:space-x-8 bg-  grid grid-cols-2 text-center gap-4   md:justify-center mb-10 ">
            ...
            <Tab>
              <TabChild
                ...
                bgSecondary="shadow-emerald-700"
...
const TabChild = (props) => {
  ...
  return (
    <>
      <button
        type="button"
        className={`font-medium border-b-2 hover:${bgSecondary} ${borderPrimary} ${textPrimary} rounded-lg text-xl shadow-[inset_0_0_8px_rgba(0,0,0,0.6)]  px-5 py-1.5 text-center bg-[#605d5d12] `}
      >
        <div className="flex gap-2 items-center">
          {icon}
          {name}
