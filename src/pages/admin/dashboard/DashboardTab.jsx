    ...
    <div className='container mx-auto'>
        <div className='tab container mx-auto'>
            ...
            <TabList className="md:flex md:space-x-8 bg-  grid grid-cols-2 text-center gap-4   md:justify-center mb-10 ">
                <Tab><TabChild icon={<MdOutlineProductionQuantityLimits />} name="Products" borderPrimary="border-purple-500" bgSecondary="shadow-purple-700" textPrimary="text-purple-500"></TabChild></Tab>
                <Tab><TabChild icon={<AiFillShopping />} name="Order" borderPrimary="border-pink-500" bgSecondary="shadow-pink-700" textPrimary="text-pink-500"></TabChild></Tab>
                <Tab><TabChild icon={ <FaUser />} name="Users" borderPrimary="border-emerald-500" bgSecondary="shadow-emerald-700" textPrimary="text-emerald-500"></TabChild></Tab>
            </TabList>
