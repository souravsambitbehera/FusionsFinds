        ...
        <>
          <div className="bg-white" style={{ backgroundColor: mode === 'dark' ? 'rgb(62 64 66)' : '', }}>
            <div className="px-1 py-10">
              <div style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }} className="lg:max-w-[1280px] md:max-w-[696px] max-w-[343px] mx-auto bg-gray-100 lg:px-20 md:px-6 px-4 py-12">
